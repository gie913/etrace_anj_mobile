...
class ReadNFCScreen extends StatefulWidget {
  @override
  _ReadNFCScreenState createState() => _ReadNFCScreenState();
}
...
class _ReadNFCScreenState extends State<ReadNFCScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Baca Kartu NFC")),
      body: Center(
        child: Container(
            ...
            children: <Widget>[
              Padding(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    // context.read<ReadDataNotifier>().toggleScan(context);
                  },
                  child: Container(
                                ...
                                Padding(
                                    ...
                                    child:
                                        nfcNotifier.listHarvestTicket.isNotEmpty
                                            ? Icon(Linecons.note, color: Colors.orange, size: 40,)
                                            : Icon(Linecons.truck, color: Colors.blue, size: 40,)),
                                Container(
                                    child:
                                        nfcNotifier.listHarvestTicket.isNotEmpty
                                            ? Text(HARVEST_TICKET, style: text16Bold,)
                                            : Text(DELIVERY_ORDER, style: text16Bold,)),
                              ],
                            )),
                        Column(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(child: Text(DELIVERY_ORDER, style: text16Bold,)),
                            ],
                          ),
                        ),
                        Column(
