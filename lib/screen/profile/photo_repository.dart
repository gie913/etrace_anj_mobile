...
class ChangeProfileRepository {
  ...
  void doChangePhotoProfile(
      String token, XFile image, onSuccess, onError) async {
    ...
    try {
      ...
      request.headers.addAll(
          APIConfiguration(baseUrl!).getDefaultHeaderFormWithToken(token));
      ...
      response.stream.transform(utf8.decoder).listen((value) {
        ...
        ChangePhotoResponse apiResponse =
            ChangePhotoResponse.fromJson(dataMedia);
