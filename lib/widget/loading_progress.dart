...
class LoadingProgress extends StatefulWidget {
  ...
  LoadingProgress(
      {this.dotOneColor = coralDark,
      this.dotTwoColor = coral,
      this.dotThreeColor = coralMedium,
...
class _LoadingProgressState extends State<LoadingProgress>
  ...
  void initState() {
    ...
    animation_1 = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
          parent: controller, curve: Interval(0.0, 0.80, curve: Curves.ease)),
    );

    animation_2 = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
          parent: controller, curve: Interval(0.1, 0.9, curve: Curves.ease)),
    );

    animation_3 = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
          parent: controller, curve: Interval(0.2, 1.0, curve: Curves.ease)),
    );
